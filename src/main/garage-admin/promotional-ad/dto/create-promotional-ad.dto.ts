...
export class CreatePromotionalAdDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Product ID if promoting specific product',
  })
  @IsOptional()
  @IsString()
  @IsUUID()
  ...
  @ApiProperty({
    example: 'Special Discount on BMW Parts',
  ...
  @ApiProperty({
    example: 'Get 25% off on all BMW spare parts this weekend only!',
  ...
  @ApiProperty({
    example: 'Dubai, UAE',
    description: 'Location where offer is valid',
  })
  @IsString()
  location: string;
