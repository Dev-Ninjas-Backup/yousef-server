...
export class PromotionalAdController {
  ...
  @ApiOperation({
    ...
    description: 'Create a new promotional advertisement. You can upload images and/or provide image URLs.'
  })
  @ApiConsumes('multipart/form-data')
  @UseInterceptors(FilesInterceptor('images', 5, new MulterService().createMulterOptions('./temp', 'ads', FileType.IMAGE)))
  create(
  ...
  @ApiOperation({
    ...
    description: 'Get all promotional ads. By default returns user\'s own ads, admin can see all.'
  })
  ...
  @ApiOperation({
    ...
    description: 'Update an existing promotional ad. Can add more images or update details.'
  })
  @ApiConsumes('multipart/form-data')
  @UseInterceptors(FilesInterceptor('images', 5, new MulterService().createMulterOptions('./temp', 'ads', FileType.IMAGE)))
  update(
