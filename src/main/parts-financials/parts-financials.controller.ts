...
export class PartsFinancialsController {
  constructor(private readonly partsFinancialsService: PartsFinancialsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePartsFinancialDto: UpdatePartsFinancialDto) {
